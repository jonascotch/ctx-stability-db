export default function Details() {
    ...
    return (
        <div className='app-container'>
            ...
            <img className='vial-image' src='/src/assets/images/drug-pic.webp' alt='vial image'/>
            </div>
            ...
            <h3 className='data-text'>Oxaliplatina Accord</h3>
            <p className='data-title'>DCI</p>
            <h3 className='data-text'>Oxaliplatina Concentrado para solução para perfusão 5 mg/ml</h3>
